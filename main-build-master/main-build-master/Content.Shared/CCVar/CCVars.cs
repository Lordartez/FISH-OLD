...
namespace Content.Shared.CCVar
{
    ...
    public sealed class CCVars : CVars
    {
        ...
        public static readonly CVarDef<int> TraitorMinPlayers =
            CVarDef.Create("traitor.min_players", 25);

        public static readonly CVarDef<int> TraitorMaxTraitors =
            CVarDef.Create("traitor.max_traitors", 10); // Assuming average server maxes somewhere from like 50-80 people
        ...
        public static readonly CVarDef<int> ZombieMinPlayers =
            CVarDef.Create("zombie.min_players", 30);
        ...
        */
        ...
        public static readonly CVarDef<string> InfoLinksPatreon =
            CVarDef.Create("infolinks.patreon", "https://boosty.to/fishstation", CVar.SERVER | CVar.REPLICATED);
        ...
        public static readonly CVarDef<string> InfoLinksAppeal =
            CVarDef.Create("infolinks.appeal", "https://discord.fishstation.ru/appeal", CVar.SERVER | CVar.REPLICATED);
