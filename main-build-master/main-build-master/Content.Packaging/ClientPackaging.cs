...
public static class ClientPackaging
{
        ...
        CancellationToken cancel)
    {
        ...
        var assemblies = new List<string> { "Content.Client", "Content.Shared", "Content.Shared.Database", "Content.Corvax.Interfaces.Client", "Content.Corvax.Interfaces.Shared", "Content._FishStation.Interfaces.Shared" };
        if (UseSecrets)
