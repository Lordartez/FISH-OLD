...
using Content.Server._FishStation.Themida;
...
namespace Content.Server.Preferences.Managers
{
    ...
    public sealed class ServerPreferencesManager : IServerPreferencesManager
    {
        ...
        public void Init()
        {
            ...
            IoCManager.Instance!.TryResolveType(out _themida); // Corvax-Sponsors
        ...
        {
            if (_themida is not null && await _themida.OnCharacterUpdate(message))
                return;
