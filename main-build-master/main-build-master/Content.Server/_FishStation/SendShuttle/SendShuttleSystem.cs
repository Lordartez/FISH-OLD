...
namespace Content.Server._FishStation.ERT.SendShuttleSystem;
...
public sealed class SendShuttle : EntitySystem
{
    ...
    private void PlayAudioAnnonce(SendShuttlePrototype proto)
    {
        ...
        _entManager.System<ServerGlobalSoundSystem>().PlayAdminGlobal(filter, proto.AudioPath, audioOption);
    }
