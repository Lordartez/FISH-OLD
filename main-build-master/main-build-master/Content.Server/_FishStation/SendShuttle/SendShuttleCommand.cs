using System.Linq;
using Content.Server._FishStation.ERT.SendShuttleSystem;
using Content.Server.Administration;
using Content.Server.Administration.Logs;
using Content.Shared._FishStation.ERT.SendShuttlePrototype;
...
namespace Content.Server_FishStation.ERT.SendShuttleCommand;

[AdminCommand(AdminFlags.SendShuttle)]
public sealed class SendShuttleCommand : IConsoleCommand
{
    ...
    public void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        switch (args.Length)
        {
            ...
            default:
                if (TryParse(args[1].ToLower(), out var temp))
                    playAnnounce = temp;
                else
                {
