...
[AdminCommand(AdminFlags.PlaytimeEdit)] // Corvax-DiscordRoles
public sealed class PlayTimeAddOverallCommand : IConsoleCommand
{
    ...
    public async void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        $"Playtime: {adminPlayer:Admin} added Overall {minutes} minutes to {player:Player}");
...
public sealed class PlayTimeAddEveryCommand : IConsoleCommand
{
    ...
    public async void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        var adminPlayer = shell.Player;
        _adminLogger.Add(LogType.AdminMessage, LogImpact.Extreme,
        $"Playtime: {adminPlayer:Admin} added Every Role {minutes} minutes to {player:Player}");
        shell.WriteLine(Loc.GetString(
...
public sealed class PlayTimeAddRoleCommand : IConsoleCommand
{
    ...
    public async void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        var adminPlayer = shell.Player;
        _adminLogger.Add(LogType.AdminMessage, LogImpact.Extreme,
        $"Playtime: {adminPlayer:Admin} added {role} {minutes} minutes to {player:Player}");
