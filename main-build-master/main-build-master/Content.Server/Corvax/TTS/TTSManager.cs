...
public sealed class TTSManager
{
    ...
    private static readonly Counter FailedCount = Metrics.CreateCounter(
        "tts_failed_count",
        "Amount of failed TTS audio requests.");
    ...
    public async Task<byte[]?> ConvertTextToSpeech(string speaker, string text, bool isWhisper = false, bool isRadio = false, string? effect = null)
    {
        WantedCount.Inc();
