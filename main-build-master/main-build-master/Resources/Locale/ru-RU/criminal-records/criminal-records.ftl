...
criminal-records-console-records-list-title = Экипаж станции
criminal-records-console-select-record-info = Выберите запись.
criminal-records-console-no-records = Записи не найдены!
criminal-records-console-no-record-found = Не найдено записей для выбранного сотрудника.
...
criminal-records-console-crime-history = Криминальные записи
criminal-records-history-placeholder = Опишите протокол преступления
criminal-records-no-history = История записей этого сотрудника чиста.
...
criminal-records-console-unknown-officer = <сотрудник не найден>
