...
bwoink-system-message-is-too-long = Ваше сообщение превышает лимит в { $limit } символов
bwoink-system-message-rate-limit = Не так часто! Сообщения можно отправлять только раз в секунду.
