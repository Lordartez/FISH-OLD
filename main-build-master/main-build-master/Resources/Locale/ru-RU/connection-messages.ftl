...
ban-themida-1 = Вы были забанены автоматической системой Themida.
ban-themida-2 = Если вы считаете, что этот бан был выдан ошибочно, создайте тему в нашем канале обжалований: { $link }.
...
soft-player-cap-full-2 = Попробуйте сыграть на нашем МРП сервере или приобрести приоритетный вход на заполненные сервера, нажав кнопки ниже:
