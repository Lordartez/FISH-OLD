...
station-goal-theater =
    Цель на вашей смены  постройка театра и проведения спектакля.
    Вам необходимо построить театр, написать сценарий спектакля и разыграть его.
    Требования к театру:
    - Сцена должна быть как минимум 12 метров
    - У актеров должна быть своя коморка, размер которой  минимум 8 метров
    - На сцене должно быть светло
    - Сцену должна снять беспроводная камера, её необходимо сохранить и передать на ЦК
    - Сцена должна быть чиста, нельзя допустить, чтобы было грязно
    Требования к сценарию:
    - Должен быть как минимум 200 слов
    - Необходимо участите минимум двух актеров
    - Сценарий должен быть с жанром Романтика, приключения, драма, комедия.
    - В сценарии всё должно быть связано по смыслу, чтобы зрители понимали суть и  сюжет
    Рекомендуется оповестить экипаж о начале спектакля заранее через консоль связи.
    Если спектакль закончили, вы должны прислать сценарий с печатью капитана,а также сделать отчёт о самой цели. Если всё будет в порядке вам будут одобрены протоколы смены экипажа.

station-goal-borgs =
    Цель вашей смены постройка боргов.
    Изготовление 8 боргов,а именно:
    - 2 инженерных борга
    - 2 медицинских борга
    - 2 карго борга
    - 2 сервис борга
    При изготовлении снабдить позитронным мозгом.
    По завершении цели необходимо прислать отчет на ЦК с печатью капитана.
