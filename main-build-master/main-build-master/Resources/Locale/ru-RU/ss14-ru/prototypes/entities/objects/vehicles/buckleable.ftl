...
ent-Vehicleparamedic = медицинская машина.
    .desc = Верный скакун парамедика.
ent-VehicleparamedicDestroyed = медицинская машина
    .desc = Уничтоженная машина парамедика.
