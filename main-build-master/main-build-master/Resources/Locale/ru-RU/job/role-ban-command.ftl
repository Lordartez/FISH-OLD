...
cmd-roleban-success = { $target } запрещено играть на роли { $role } по причине { $reason } { $length } админом { $admin }.
cmd-roleban-success-rp = Администратор запретил { $target } играть на роли { $role } до { $length }.
cmd-roleban-success-rp-perm = Администратор навсегда запретил { $target } играть на роли { $role }.
