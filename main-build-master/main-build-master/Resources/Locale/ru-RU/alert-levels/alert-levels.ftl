...
alert-level-sierra-announcement = Центральное командование объявило на станции уровень угрозы "Сьерра". Выявлена угроза биологического загрязнения, объявлен карантин. Полная изоляция всего экипажа станции. Все шаттлы должны немедленно пристыковаться к станции или будут сбиты. Служба безопасности должна постоянно иметь при себе оружие, гражданский персонал обязан немедленно пройти в свои отделы. Службе безопасности разрешено применение летальной силы за неподчинение.
alert-level-sierra-instructions = Объявлен карантин, полная изоляция всего экипажа станции. Экипаж обязан подчиняться правомерным приказам сотрудников Службы Безопасности. Переключите режим работы своего костюма в режим "Координаты", находитесь в своём отделе и избегайте контактов с другими членами экипажа.
