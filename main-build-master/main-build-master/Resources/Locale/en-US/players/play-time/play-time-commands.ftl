...
# - playtime_addevery
cmd-playtime_addevery-desc = Adds the specified minutes to a player's every role playtime
cmd-playtime_addevery-help = Usage: {$command} <user name> <minutes>
cmd-playtime_addevery-succeed = Increased every role time for {$username} to {TOSTRING($time, "dddd\\:hh\\:mm")}
cmd-playtime_addevery-arg-user = <user name>
cmd-playtime_addevery-arg-minutes = <minutes>
cmd-playtime_addevery-error-args = Expected exactly two arguments
