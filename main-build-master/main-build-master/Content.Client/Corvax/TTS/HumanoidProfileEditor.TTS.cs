...
public sealed partial class HumanoidProfileEditor
{
    ...
    private readonly CancellationTokenSource _ttsTimerCancel = new();
    ...
    private void InitializeVoice()
    {
        ...
        _voicePlayButton.OnPressed += _ =>
        {
            if (_voicePlayButton.Disabled)
            {
                return;
            }
            _voicePlayButton.Disabled = true;
            PlayTTS();
            Timer.Spawn(TimeSpan.FromSeconds(2), () =>
            {
                _voicePlayButton.Disabled = false;
            }, _ttsTimerCancel.Token);
        };
