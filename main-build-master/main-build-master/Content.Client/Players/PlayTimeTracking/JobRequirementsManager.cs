...
public sealed class JobRequirementsManager
{
    ...
    public event EventHandler<PlaytimeTrackerLobbyReceived>? PlayTimeReceived;
    ...
    private void RxPlayTime(MsgPlayTime message)
    {
        ...
        if (_roles.TryGetValue("Overall", out var overallTime))
        {
            PlayTimeReceived?.Invoke(this, new PlaytimeTrackerLobbyReceived(overallTime));
        }
        Updated?.Invoke();
    }
